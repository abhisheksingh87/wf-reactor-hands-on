...
import com.wellsfargo.cto.eai.reactor.repository.BlockingUserRepository;
...
/**
 * How to call blocking code from Reactive one with adapted concurrency strategy for
...
//========================================================================================
	...
	public void fastPublisherSlowSubscriber() {
		...
		assertThat(it.next()).isEqualTo(User.MIKE);
